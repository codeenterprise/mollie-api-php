...
use Coe\Mollie\Api\Endpoints\BalanceEndpoint;
use Coe\Mollie\Api\Endpoints\BalanceReportEndpoint;
use Coe\Mollie\Api\Endpoints\BalanceTransactionEndpoint;
use Coe\Mollie\Api\Endpoints\ChargebackEndpoint;
use Coe\Mollie\Api\Endpoints\ClientEndpoint;
use Coe\Mollie\Api\Endpoints\ClientLinkEndpoint;
use Coe\Mollie\Api\Endpoints\CustomerEndpoint;
use Coe\Mollie\Api\Endpoints\CustomerPaymentsEndpoint;
use Coe\Mollie\Api\Endpoints\InvoiceEndpoint;
use Coe\Mollie\Api\Endpoints\MandateEndpoint;
use Coe\Mollie\Api\Endpoints\MethodEndpoint;
use Coe\Mollie\Api\Endpoints\OnboardingEndpoint;
use Coe\Mollie\Api\Endpoints\OrderEndpoint;
use Coe\Mollie\Api\Endpoints\OrderLineEndpoint;
use Coe\Mollie\Api\Endpoints\OrderPaymentEndpoint;
use Coe\Mollie\Api\Endpoints\OrderRefundEndpoint;
use Coe\Mollie\Api\Endpoints\OrganizationEndpoint;
use Coe\Mollie\Api\Endpoints\OrganizationPartnerEndpoint;
use Coe\Mollie\Api\Endpoints\PaymentCaptureEndpoint;
use Coe\Mollie\Api\Endpoints\PaymentChargebackEndpoint;
use Coe\Mollie\Api\Endpoints\PaymentEndpoint;
use Coe\Mollie\Api\Endpoints\PaymentLinkEndpoint;
use Coe\Mollie\Api\Endpoints\PaymentRefundEndpoint;
use Coe\Mollie\Api\Endpoints\PaymentRouteEndpoint;
use Coe\Mollie\Api\Endpoints\PermissionEndpoint;
use Coe\Mollie\Api\Endpoints\ProfileEndpoint;
use Coe\Mollie\Api\Endpoints\ProfileMethodEndpoint;
use Coe\Mollie\Api\Endpoints\RefundEndpoint;
use Coe\Mollie\Api\Endpoints\SettlementCaptureEndpoint;
use Coe\Mollie\Api\Endpoints\SettlementChargebackEndpoint;
use Coe\Mollie\Api\Endpoints\SettlementPaymentEndpoint;
use Coe\Mollie\Api\Endpoints\SettlementRefundEndpoint;
use Coe\Mollie\Api\Endpoints\SettlementsEndpoint;
use Coe\Mollie\Api\Endpoints\ShipmentEndpoint;
use Coe\Mollie\Api\Endpoints\SubscriptionEndpoint;
use Coe\Mollie\Api\Endpoints\TerminalEndpoint;
use Coe\Mollie\Api\Endpoints\WalletEndpoint;
...
use Coe\Mollie\Api\HttpAdapter\MollieHttpAdapterPicker;
use Coe\Mollie\Api\Idempotency\DefaultIdempotencyKeyGenerator;
